...
class TestDocumentIngestion:
    ...
    @pytest.mark.integration
    def test_ingest_documents_to_chroma(
        self, clean_chroma_collection, sample_docs_path
    ):
        ...
        metadatas = [
            {"source": str(sample_docs_path), "chunk_id": i} for i in range(len(chunks))
        ]
...
class TestBasicRAG:
    ...
    def test_answer_question_about_python(self, rag_chain, sample_docs_path):
        ...
        assert any(
            word in answer_lower for word in ["programming", "language", "python"]
    ...
    def test_answer_question_about_ml(self, rag_chain, sample_docs_path):
        ...
        assert any(
            ...
            for word in ["supervised", "unsupervised", "learning", "types"]
...
class TestConversationMemory:
    ...
    def test_context_aware_followup(self, rag_chain, sample_docs_path):
        ...
        assert any(
            word in answer2
            for word in ["http", "method", "get", "post", "put", "delete"]
